 ...
 *
 * <p>This Value Object is immutable and validates that the JSON content is not blank.
 * It provides JSON validation through {@link #isValidJson()} method.</p>
 *
 * <p>As a pure domain model, this class has NO dependencies on Spring or JPA annotations.
 * JSON validation uses a lightweight heuristic approach without external dependencies.</p>
 *
 * <h3>JSON Validation Strategy</h3>
 * <p>Uses lightweight syntax checking (braces/brackets matching) rather than
 * full parsing to maintain domain purity. Full validation should be performed
 * by infrastructure layer mappers when needed.</p>
 *
...
public record EquipmentData(String jsonContent) {
     ...
     *   <li>Valid JSON structure markers</li>
     * </ul>
     *
     * <p><b>Note:</b> For full JSON schema validation, use infrastructure layer
     * mappers with Jackson ObjectMapper. This method keeps the domain layer
     * dependency-free.</p>
     *
     ...
     *
     * <p>This method is provided for infrastructure layer mappers
     * to convert between domain and persistence models.</p>
     *
