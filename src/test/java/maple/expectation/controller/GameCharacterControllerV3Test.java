 ...
 * <h4>테스트 범위</h4>
 * <ul>
 *   <li>GET /{userIgn}/equipment - Zero-Copy GZIP 스트리밍</li>
 *   <li>GET /{userIgn}/expectation - 비동기 기대값 조회</li>
 * </ul>
 */
@Tag("unit")
    ...
    class GetEquipmentStreamTest {
        ...
        void whenStreamingEquipment_shouldReturnGzipResponse() throws Exception {
            ...
            doAnswer(invocation -> {
                ...
                return null;
            }).when(equipmentService).streamEquipmentDataRaw(eq(userIgn), any(OutputStream.class));
        ...
        void shouldCallEquipmentService() {
            ...
            given(equipmentService.calculateTotalExpectationAsync(userIgn))
                    .willReturn(CompletableFuture.completedFuture(
                            TotalExpectationResponse.builder().build()
                    ));
