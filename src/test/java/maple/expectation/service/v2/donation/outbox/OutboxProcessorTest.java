 ...
 * <h3>P0 검증</h3>
 * <ul>
 *   <li>P0-1: processEntry 실패 시 handleFailure 호출 (Zombie Loop 방지)</li>
 *   <li>P0-2: 항목별 독립 트랜잭션 처리</li>
 * </ul>
 *
...
class OutboxProcessorTest {
    ...
    class ZombieLoopPreventionTest {
        ...
        void shouldCallHandleFailureOnException() {
            ...
            Boolean result = ReflectionTestUtils.invokeMethod(
                    processor, "processEntryInTransaction", 1L);
    ...
    class IndependentTransactionTest {
        ...
        void shouldSeparateFetchAndProcess() {
            ...
            given(outboxRepository.saveAll(anyList()))
                    .willReturn(List.of(entry1, entry2));
    ...
    private DonationOutbox createTestOutbox(Long id, String requestId) {
        DonationOutbox outbox = DonationOutbox.create(requestId, "DONATION_COMPLETED",
                "{\"amount\":1000,\"donor\":\"TestUser\"}");
