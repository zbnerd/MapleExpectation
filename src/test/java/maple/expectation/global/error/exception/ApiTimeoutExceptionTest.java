 ...
 * <p>ApiTimeoutException은 CircuitBreakerRecordMarker를 구현하여
 * 서킷브레이커가 타임아웃을 기록하도록 합니다.</p>
 *
 * <ul>
 *   <li>ApiTimeoutException: API 레벨 timeout → 서킷브레이커 기록</li>
 *   <li>ExpectationCalculationUnavailableException: Follower timeout → 서킷브레이커 무시</li>
 * </ul>
 */
class ApiTimeoutExceptionTest {
    ...
    class CauseChainTests {
        ...
        void shouldPreserveCauseChain() {
            ...
            assertThat(exception.getCause().getMessage()).isEqualTo("Connection timeout after 25 seconds");
        }
