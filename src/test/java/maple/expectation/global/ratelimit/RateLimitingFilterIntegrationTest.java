 ...
 *
 * <p>Spring wiring 검증: Filter → Facade → Service → Strategy</p>
 * <p>Note: RateLimitingFacade를 MockitoBean으로 대체하여 Redis 의존성 제거</p>
 */
@SpringBootTest
...
class RateLimitingFilterIntegrationTest {
    ...
    @MockitoBean
    private RateLimitingFacade rateLimitingFacade;
    ...
    class RateLimitExceededTests {
        ...
        void whenRateLimitExceeded_Returns429WithRetryAfter() throws Exception {
            ...
            mockMvc.perform(get("/api/v1/characters/testIgn"))
