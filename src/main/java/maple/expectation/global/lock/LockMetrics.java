 ...
 *
 * <h3>목적</h3>
 * <p>락 획득 성능을 모니터링하여 병목 현상을 조기에 감지합니다.</p>
 *
 * <h3>메트릭</h3>
 * <ul>
 *   <li><b>Lock Wait Time (Timer)</b>: p50, p95, p99 백분위수</li>
 *   <li><b>Lock Failures (Counter)</b>: 구현체별(redis/mysql) 실패 횟수</li>
 *   <li><b>Active Locks (Gauge)</b>: 현재 획득 중인 락 수</li>
 * </ul>
 *
 * <h3>CLAUDE.md 준수사항</h3>
 * <ul>
 *   <li>Section 12: Zero Try-Catch Policy - LogicExecutor 패턴 사용</li>
 *   <li>Section 17: 소문자 점 표기법 사용 (lock.wait.time 등)</li>
...
public class LockMetrics {
    ...
    public void init() {
        ...
        redisFailureCounter = Counter.builder("lock.acquisition.failure.total")
                .description("Total lock acquisition failures")
                .tag("implementation", "redis")
                .register(registry);

        mysqlFailureCounter = Counter.builder("lock.acquisition.failure.total")
                .description("Total lock acquisition failures")
        ...
        log.info("[LockMetrics] Initialized - Timer (p50/p95/p99), Counters (redis/mysql failures), Gauges (active locks) registered");
    }

    /**
     * 락 대기 시간 기록
     *
     * <p>락 획득 시작 전과 성공 후에 호출하여 대기 시간을 측정합니다.</p>
     *
