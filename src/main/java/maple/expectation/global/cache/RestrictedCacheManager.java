 ...
 *
 * 허용된 캐시 이름만 접근 가능하도록 구조적으로 제한합니다.
 * disableCreateOnMissingCache() 지원 여부와 무관하게 동작합니다.
 *
...
public class RestrictedCacheManager implements CacheManager {
    ...
    /**
     * 의도적으로 축소 반환: delegate가 반환하는 이름과 불일치해도 정상.
     * L2에는 expectationResult만 허용하므로, 이 값만 반환한다.
     */
    @Override
