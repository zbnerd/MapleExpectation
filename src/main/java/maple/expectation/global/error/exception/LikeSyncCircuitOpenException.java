 ...
 *
 * <p>CircuitBreaker가 열려 batch 동기화가 실패할 때 발생합니다. 상위 레이어에서 보상 트랜잭션을 실행하도록 전파합니다.
 *
 * <p>CircuitBreakerIgnoreMarker: 서킷 오픈 자체는 서킷 카운트에 포함하지 않음
 */
public class LikeSyncCircuitOpenException extends ServerBaseException
