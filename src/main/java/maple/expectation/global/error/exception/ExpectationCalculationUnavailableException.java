 ...
 *
 * <p>Single-flight 패턴에서 follower가 leader의 결과를 기다리다 timeout되었을 때 발생합니다.
 * HTTP 503 Service Unavailable로 응답됩니다.</p>
 *
 * <h4>발생 조건</h4>
 * <ul>
 *   <li>Follower 대기 timeout (5초)</li>
 *   <li>캐시 재조회 실패</li>
 * </ul>
 *
 * <h4>CircuitBreakerIgnoreMarker 적용 이유</h4>
 * <p>이 예외는 외부 서비스 장애가 아닌 일시적인 부하 상황을 나타내므로
 * 서킷브레이커에 기록하지 않습니다.</p>
 *
