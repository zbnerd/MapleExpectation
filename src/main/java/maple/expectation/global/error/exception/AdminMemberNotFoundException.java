 ...
 *
 * <p>Admin에게 커피(후원)를 보내려면 해당 Admin의 fingerprint로
 * Member 레코드가 등록되어 있어야 합니다.</p>
 *
 * <p>보안: fingerprint는 에러 메시지에 포함하지 않음</p>
 */
public class AdminMemberNotFoundException extends ClientBaseException implements CircuitBreakerIgnoreMarker {
