 ...
 *
 * <p>Redis 서버 재시작, 네트워크 장애, 스크립트 문법 오류 등으로
 * Lua Script 실행이 실패할 때 발생합니다.</p>
 *
 * <p>{@link CircuitBreakerRecordMarker}를 구현하여 연속 실패 시
 * 서킷브레이커가 작동하도록 합니다.</p>
 */
public class RedisScriptExecutionException extends ServerBaseException implements CircuitBreakerRecordMarker {
