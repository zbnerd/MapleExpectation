 ...
 * <h3>개선 효과</h3>
 * <ul>
 *   <li>전역 핸들러에서 "어디서 터진 에러인지" 명확히 구분 가능</li>
 *   <li>taskName으로 에러 발생 지점 추적 용이</li>
 *   <li>CommonErrorCode.INTERNAL_SERVER_ERROR로 통일된 에러 코드 관리</li>
 *   <li>Micrometer 메트릭에 정확한 예외 이름 기록</li>
 * </ul>
 *
 * @since 1.0.0
 */
