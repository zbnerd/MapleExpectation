 ...
 * <h3>사용 사례</h3>
 *
 * <p>서버 시작 시 StarforceLookupTable 초기화가 완료되지 않은 상태에서 기대값 계산 요청이 들어온 경우
 *
 * <h3>Circuit Breaker</h3>
 *
 * <p>초기화 미완료는 시스템 장애로 분류 (CircuitBreakerRecordMarker)
 */
public class StarforceNotInitializedException extends ServerBaseException
