 ...
 *
 * <p>포인트 이체 시 발신자 UUID로 Member를 조회할 수 없을 때 발생합니다.</p>
 */
public class SenderMemberNotFoundException extends ClientBaseException implements CircuitBreakerIgnoreMarker {
