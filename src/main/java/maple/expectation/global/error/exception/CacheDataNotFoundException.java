 ...
 *
 * <h3>사용 사례</h3>
 * <p>TieredCache에서 데이터를 조회했으나 null/empty인 경우.
 * 캐시 로직의 버그를 의심할 수 있는 상황입니다.</p>
 *
 * <h3>Circuit Breaker</h3>
 * <p>캐시 데이터 부재는 시스템 장애로 분류 (CircuitBreakerRecordMarker)</p>
 */
public class CacheDataNotFoundException extends ServerBaseException implements CircuitBreakerRecordMarker {
