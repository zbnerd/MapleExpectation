 ...
 * <h3>사용 사례</h3>
 * <ul>
 *   <li>Heap 메모리 부족으로 Lookup Table 초기화 불가</li>
 *   <li>Thread Pool 리소스 고갈</li>
 *   <li>디스크 공간 부족</li>
 * </ul>
 *
 * <h3>Circuit Breaker</h3>
 * <p>시스템 리소스 부족은 서킷브레이커에 기록되어야 함 (CircuitBreakerRecordMarker)</p>
 *
 * @see maple.expectation.config.LookupTableInitializer 사용 예시
 */
public class InsufficientResourceException extends ServerBaseException implements CircuitBreakerRecordMarker {
