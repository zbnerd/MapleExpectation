 ...
 *
 * <p>동일한 API Key는 항상 동일한 fingerprint를 생성하여
 * API Key를 저장하지 않고도 계정을 식별할 수 있게 합니다.</p>
 *
 * <p>보안 고려사항:
 * <ul>
 *   <li>fingerprint 비교 시 Timing Attack 방지를 위해 상수 시간 비교 사용</li>
 *   <li>serverSecret은 환경변수로 주입받아 하드코딩 방지</li>
 * </ul>
 * </p>
 */
@Slf4j
...
public class FingerprintGenerator {
    ...
    /**
     * API Key와 fingerprint가 일치하는지 검증합니다.
     * Timing Attack 방지를 위해 상수 시간 비교를 사용합니다.
     *
