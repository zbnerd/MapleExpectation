 ...
 *   <li>Admin 바이패스 판단</li>
 *   <li>바이패스 경로 체크</li>
 *   <li>RateLimitingService 호출 조율</li>
 * </ul>
 * </p>
 *
 * <h4>5-Agent Council 합의</h4>
 * <ul>
 *   <li><b>Blue Agent</b>: Facade → Service 책임 분리</li>
 *   <li><b>Purple Agent</b>: Admin 바이패스 로직</li>
 *   <li><b>Red Agent</b>: 조건부 활성화/비활성화</li>
 * </ul>
 *
 * @since Issue #152
 */
...
public class RateLimitingFacade {
     ...
     * <h4>처리 순서</h4>
     * <ol>
     *   <li>전체 Rate Limiting 비활성화 체크</li>
     *   <li>바이패스 경로 체크 (Swagger, Actuator 등)</li>
     *   <li>Admin 바이패스 체크</li>
     *   <li>RateLimitingService 호출</li>
     * </ol>
     *
