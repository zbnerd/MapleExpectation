 ...
 * <ul>
 *   <li>Service: 비즈니스 로직 (전략 선택 및 토큰 소비)</li>
 *   <li>Facade: 오케스트레이션 (Admin 바이패스, 경로 체크 등)</li>
 * </ul>
 * </p>
 *
 * <h4>전략 선택 로직</h4>
 * <ul>
 *   <li>인증 사용자: User 기반 Rate Limiting (fingerprint)</li>
 *   <li>비인증 사용자: IP 기반 Rate Limiting</li>
 * </ul>
 *
 * @since Issue #152
 */
...
public class RateLimitingService {
    ...
    public ConsumeResult checkRateLimit(RateLimitContext context) {
        ...
        if (context.isAuthenticated() && userRateLimiter.isEnabled()) {
            String fingerprint = context.authenticatedUser()
