 ...
 *
 * <p>CLAUDE.md 섹션 4 DIP 준수: 구체적인 구현이 아닌 인터페이스에 의존</p>
 *
 * <h4>구현체</h4>
 * <ul>
 *   <li>IpBasedRateLimiter - IP 기반 Rate Limiting</li>
 *   <li>UserBasedRateLimiter - 인증 사용자 기반 Rate Limiting</li>
 * </ul>
 *
 * @since Issue #152
 */
public interface RateLimiter {
     ...
     * 요청에 대한 토큰 소비 시도
     *
     * <p>Bucket4j의 tryConsume()을 호출하여 Rate Limit 확인</p>
     *
