 ...
 *
 * <p>Bucket4j 기반 분산 Rate Limiting 설정</p>
 *
 * <h4>5-Agent Council 합의</h4>
 * <ul>
 *   <li><b>Blue Agent</b>: @ConfigurationProperties + @Validated 패턴</li>
 *   <li><b>Red Agent</b>: fail-fast 원칙 - 필수값 검증</li>
 *   <li><b>Purple Agent</b>: Admin 바이패스 + IP 스푸핑 방지</li>
 * </ul>
 *
 * <p>CLAUDE.md 섹션 5 준수: No Hardcoding - 모든 값은 설정 파일로 관리</p>
 */
@Getter
@Setter
@Validated
...
public class RateLimitProperties {
     ...
     *
     * <ul>
     *   <li>fail-open: Redis 장애 시 요청 허용 (가용성 > 보안)</li>
     *   <li>fail-close: Redis 장애 시 요청 거부 (보안 > 가용성)</li>
     * </ul>
     */
    @NotBlank
    private String failureMode = "fail-open";

    /**
     * Rate Limit 키 접두사 (Redis Cluster Hash Tag 포함)
     *
     * <p>CLAUDE.md 섹션 8-1 준수: Cluster Hash Tag로 동일 슬롯 보장</p>
     */
    @NotBlank
     ...
     */
    @NotNull
    private IpLimitConfig ip = new IpLimitConfig();
     ...
     *
     * <p>Purple Agent P1 FIX: IP 스푸핑 방지 - 신뢰할 수 있는 프록시에서만 X-Forwarded-For 사용</p>
     */
     ...
     */
    private List<String> bypassPaths = List.of(
            "/swagger-ui/**",
            "/v3/api-docs/**",
            "/actuator/health",
            "/actuator/info"
    ...
    public static class IpLimitConfig {
         ...
         *
         * <p>Greedy Refill: window 동안 capacity까지 균등 리필</p>
         */
        @Min(1)
         ...
         * 토큰 리필 주기 (기본: 6초)
         *
         * <p>계산: window / (capacity / refillTokens) = 60s / 10 = 6s</p>
         */
        @NotNull
        private Duration refillPeriod = Duration.ofSeconds(6);
    }
