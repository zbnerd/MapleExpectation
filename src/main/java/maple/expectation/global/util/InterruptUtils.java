 ...
 * 인터럽트 복원 유틸리티
 *
 * <p>예외 그래프(cause chain + suppressed)에서 InterruptedException 또는
 * InterruptedIOException이 발견되면 현재 스레드의 interrupt 플래그를 복원합니다.</p>
 *
 * <h3>통합 이유 (P1-2)</h3>
 * <ul>
 *   <li>{@code ExecutionPipeline}: cause chain만 스캔</li>
 *   <li>{@code DefaultCheckedLogicExecutor}: cause + suppressed 스캔</li>
 *   <li>두 구현을 통합하여 일관된 동작 보장</li>
 * </ul>
 *
 * @since 2.5.0
 */
public final class InterruptUtils {
    ...
    /**
     * Throwable 그래프에 InterruptedException 또는 InterruptedIOException이
     * 포함되어 있으면 현재 스레드의 interrupt 플래그를 복원합니다.
     *
     ...
     *
     * <p>cause chain과 suppressed 배열을 모두 순회합니다.</p>
     *
