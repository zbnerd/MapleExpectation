 ...
 * <p>기존 ExpectationWriteBackBuffer 로직을 MessageQueueStrategy 인터페이스로 리팩토링</p>
 *
 * <h3>특성</h3>
 * <ul>
 *   <li>지연: 0.1ms (Lock-free)</li>
 *   <li>처리량: 965 RPS (단일 노드)</li>
 *   <li>내구성: Low (장애 시 데이터 유실)</li>
 *   <li>비용: Free</li>
 * </ul>
 *
 ...
 *   <li>Green (Performance): CAS 기반 카운터로 경합 최소화</li>
 *   <li>Purple (Auditor): msgId 기반 ACK로 Iteration 4 준수</li>
 *   <li>Yellow (QA): 테스트 용이성을 위한 단순 구조</li>
 *   <li>Red (SRE): 백프레셔 + DLQ 지원</li>
 * </ul>
 *
 * <h3>한계점 (Scale-out 불가)</h3>
 * <ul>
 *   <li>각 인스턴스가 독립 버퍼 보유</li>
 *   <li>배포/장애 시 데이터 유실 위험</li>
 *   <li>트래픽 > 1,000 RPS 시 V5(Redis) 전환 권장</li>
 * </ul>
 *
 * @param <T> 메시지 페이로드 타입
