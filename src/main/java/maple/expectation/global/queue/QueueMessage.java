 ...
 * <p>GPT-5 Iteration 4 (A) 반영: msgId 기반 ACK를 위한 메시지 래퍼</p>
 *
 * <h3>5-Agent Council 합의</h3>
 * <ul>
 *   <li>Purple (Auditor): Record로 immutability 보장</li>
 *   <li>Yellow (QA): retryCount로 재시도 추적</li>
 * </ul>
 *
 * <h3>용도</h3>
 * <ul>
 *   <li>consume() 반환 시 msgId와 payload를 함께 제공</li>
 *   <li>ack(msgId) / nack(msgId, retryCount) 호출에 필요한 정보 제공</li>
 *   <li>Re-drive 시 payload 복원에 사용</li>
 * </ul>
 *
