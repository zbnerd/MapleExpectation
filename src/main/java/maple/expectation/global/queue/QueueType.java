 ...
 * <p>ADR-012 WriteBackBufferStrategy 설계 반영</p>
 *
 * <h3>5-Agent Council 합의</h3>
 * <ul>
 *   <li>Blue (Architect): OCP - 설정값 하나로 전략 교체</li>
 *   <li>Red (SRE): 모니터링 태그로 사용</li>
 * </ul>
 *
 * <h3>전략 비교</h3>
 * <table>
...
public enum QueueType {
     ...
     *
     * <ul>
     *   <li>장점: 0.1ms 지연, 비용 없음</li>
     *   <li>단점: Scale-out 불가, 장애 시 데이터 유실</li>
     *   <li>적합: 단일 노드, 트래픽 < 1,000 RPS</li>
     * </ul>
     */
    IN_MEMORY("in-memory"),
     ...
     *
     * <ul>
     *   <li>장점: Scale-out 가능, At-Least-Once 보장</li>
     *   <li>단점: 네트워크 RTT 추가 (1-2ms)</li>
     *   <li>적합: 다중 노드, 트래픽 800+ RPS</li>
     * </ul>
     */
    REDIS_LIST("redis"),
     ...
     *
     * <ul>
     *   <li>장점: 무제한 확장, Exactly-Once 가능</li>
     *   <li>단점: 운영 복잡도 높음, 비용 높음</li>
     *   <li>적합: 대규모 이벤트, 트래픽 10,000+ RPS</li>
     * </ul>
     */
    KAFKA("kafka"),
