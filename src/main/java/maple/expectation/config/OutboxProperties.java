 ...
 * <h4>설계 의도</h4>
 * <ul>
 *   <li>P1-8: BATCH_SIZE, STALE_THRESHOLD 하드코딩 제거 -> YAML 외부화</li>
 *   <li>P1-2: instanceId @Value 주입 -> 생성자 주입으로 변경</li>
 *   <li>P1-5: Exponential Backoff 최대 대기 시간 설정</li>
 * </ul>
 *
...
public class OutboxProperties {
     ...
     * <p>기본값: 100건. 너무 크면 트랜잭션 락 시간 증가, 너무 작으면 오버헤드 증가</p>
     */
    @Min(1)
    @Max(1000)
    ...
    /**
     * Stalled 판정 기준 시간
     * <p>PROCESSING 상태로 이 시간 이상 유지된 항목을 Zombie로 판정</p>
     */
    @NotNull
     ...
     * <p>retryCount가 커져도 이 시간을 초과하지 않음</p>
     */
    @NotNull
