 ...
 *
 * <h3>분산 환경 안전</h3>
 * <p><b>분산 락 미적용 사유</b>: {@link maple.expectation.repository.v2.NexonApiOutboxRepository}의
 ...
 * <h3>메트릭 수집</h3>
 * <ul>
 *   <li>updatePendingCount(): 배치 처리 전후로 Pending 수 갱신</li>
 *   <li>처리 결과 로깅: 성공/실패 건수 기록</li>
 * </ul>
 *
...
public class NexonApiOutboxScheduler {
     ...
     * <h3>처리 흐름</h3>
     * <ol>
     *   <li>메트릭 갱신: 처리 전 Pending 수 기록</li>
     *   <li>폴링 및 처리: processor.pollAndProcess() 호출</li>
     *   <li>메트릭 갱신: 처리 후 Pending 수 기록</li>
     * </ol>
     */
