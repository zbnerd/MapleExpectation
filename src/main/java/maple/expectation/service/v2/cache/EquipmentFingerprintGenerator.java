 ...
 *
 * <p>updatedAt을 epoch second로 변환하여 캐시 키에 사용합니다.</p>
 *
 * <h4>null 처리 정책</h4>
 * <p>updatedAt이 null이면 "0"을 반환하고 메트릭에 기록합니다.
 * 이 경우 TTL 기반으로 캐시가 무효화됩니다.</p>
 *
...
public class EquipmentFingerprintGenerator {
     ...
     *
     * <p>금융수준 캐시 키 충돌 방지를 위해 SHA-256 사용</p>
     *
     ...
     *
     * <p>NoSuchAlgorithmException은 JVM에서 SHA-256을 항상 지원하므로
     * 사실상 발생하지 않지만, checked 예외이므로 CheckedLogicExecutor로 처리합니다.</p>
     */
