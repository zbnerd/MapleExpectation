 ...
 * <ul>
 *   <li>Nexon API OCID 조회</li>
 *   <li>DB 저장 (트랜잭션 범위 최소화)</li>
 *   <li>네거티브 캐시 (CharacterNotFoundException 시)</li>
 *   <li>포지티브 캐시 (OCID 캐시)</li>
 * </ul>
 *
 * <h3>분해 근거</h3>
 * <p>OcidResolver.createNewCharacter()와 GameCharacterService.createNewCharacter()의
 * 공통 로직 추출 (CLAUDE.md Section 4 - SOLID SRP)</p>
 *
 * @see OcidResolver
...
public class CharacterCreationService {
     ...
     * <p>API 호출은 트랜잭션 밖, DB 작업만 트랜잭션 안</p>
     *
     ...
     *
     * <p>PR #199, #241 Fix: CompletionException unwrap 후 CharacterNotFoundException 감지</p>
     */
