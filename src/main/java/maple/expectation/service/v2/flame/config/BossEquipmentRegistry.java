 ...
 * 보스 드랍 장비 레지스트리
 *
 * <p>FLAME_LOGIC.md의 보스 장비 목록을 코드로 관리합니다. 무기는 접두어(prefix) 매칭, 장신구/방어구는 접두어 또는 정확한 이름 매칭으로 판별합니다.
 */
public final class BossEquipmentRegistry {
  ...
  private static final Set<String> BOSS_WEAPON_PREFIXES =
      Set.of(
          "자쿰의 포이즈닉",
          "네크로",
          "로얄 반 레온",
  ...
  /** 보스 드랍 방어구 접두어 (세트 장비) */
  private static final Set<String> BOSS_ARMOR_PREFIXES =
      Set.of(
          "네크로", "로얄 반 레온", "라이온하트", "드래곤테일", "팔콘윙", "레이븐혼", "샤크투스", "이글아이", "트릭스터", "하이네스", "앱솔랩스",
          "아케인셰이드", "에테르넬");

  /** 보스 드랍 장신구 (정확한 이름) */
  private static final Set<String> BOSS_ACCESSORY_NAMES =
      Set.of(
          "아쿠아틱 레터 눈장식",
          "블랙빈 마크",
          "파풀라투스 마크",
