 ...
 *
 * <h3>역할</h3>
 * <p>{@link FlameDpCalculator}에 위임하여 환생의 불꽃 기대 시도 횟수를 계산합니다.</p>
 *
 * <h3>설계 근거</h3>
 * <p>DIP 준수를 위해 {@link FlameTrialsProvider} 인터페이스를 구현합니다.
 * V4 PresetCalculationHelper는 구체 클래스가 아닌 인터페이스에 의존합니다.</p>
 *
