 ...
 * <h3>핵심 기능</h3>
 * <ul>
 *   <li>P(X >= target) 꼬리 확률 계산</li>
 *   <li>기하분포 기반 기대 시도 횟수 계산</li>
 * </ul>
 *
 * <h3>Tail Clamp 최적화</h3>
 * <p>Tail Clamp가 적용된 DensePmf의 경우 mass[target]이 곧 P(X >= target)이므로
 * 별도 합산 불필요 (성능 + 정밀도 이점)</p>
 */
@Component
public class TailProbabilityCalculator {
     ...
     * P(X >= target) 꼬리 확률 산출
     *
     * <p>Tail Clamp가 적용된 경우 mass[target]이 곧 꼬리 확률입니다.</p>
     * <p>Clamp 미적용 시 Kahan summation으로 정밀하게 합산합니다.</p>
     *
     * @param pmf              확률질량함수
     * @param target           목표 합계
     ...
     *
     * <p>주의: 이 값은 "기대값"이 아니라 "올림한 추정치"입니다.</p>
     *
     * @param probability 성공 확률
     ...
     *
     * <p>DoD 1e-12 기준 충족을 위해 오차 보정 적용</p>
     *
     * @param pmf    확률질량함수
     * @param target 시작 인덱스
