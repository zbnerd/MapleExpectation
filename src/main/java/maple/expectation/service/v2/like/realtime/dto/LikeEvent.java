 ...
 *
 * <p>인스턴스 간 L1 캐시 무효화를 위한 이벤트 메시지
 *
 * <h3>5-Agent Council 합의</h3>
 *
 * <ul>
 *   <li>Blue (Architect): Record로 불변성 보장
 *   <li>Green (Performance): 최소한의 필드로 네트워크 부하 최소화
 *   <li>Purple (Data): eventType으로 LIKE/UNLIKE 구분
 * </ul>
 *
...
public record LikeEvent(
    String userIgn, long newDelta, EventType eventType, String sourceInstanceId, Instant timestamp)
