...
public class RedisLikeEventSubscriber implements LikeEventSubscriber {
    ...
    public void subscribe() {
        ...
        executor.executeVoid(() -> {
            ...
            log.info("[LikeEventSubscriber] Subscribed to topic: {}, instanceId={}",
                    RedisKey.LIKE_EVENTS_TOPIC.getKey(), instanceId);
        }, context);
    }
     ...
     * 이벤트 수신 및 처리
     *
     * <p>P0-3 대응: Self-skip으로 불필요한 캐시 무효화 방지</p>
     */
    @Override
    public void onEvent(LikeEvent event) {
        ...
        executor.executeVoid(() -> {
            ...
            recordEventReceived();
            log.debug("[LikeEventSubscriber] L1 cache evicted: userIgn={}, source={}, delta={}",
