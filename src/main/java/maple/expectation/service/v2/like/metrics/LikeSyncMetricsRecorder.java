 ...
 * <ul>
 *   <li>동기화 메트릭: like.sync.duration, like.sync.entries, like.sync.total.count, like.sync.failed.entries</li>
 *   <li>복구 메트릭: like.sync.restore.count, like.sync.restore.likes</li>
 *   <li>청크 메트릭: like.sync.chunk.processed, like.sync.chunk.failed</li>
 * </ul>
 *
 * <h3>분해 근거</h3>
 * <p>LikeSyncService(440줄)의 메트릭 관련 코드를 분리하여 SRP 준수 (CLAUDE.md Section 4)</p>
 */
@Component
...
public class LikeSyncMetricsRecorder {
     ...
     */
    public void recordSyncMetrics(int entries, long totalCount, long failedEntries, long startNanos, String result) {
