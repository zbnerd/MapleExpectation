 ...
 * <p>금융수준 안전 설계:
 * <ul>
 *   <li>보상 트랜잭션 실패 시 데이터 영구 손실 방지</li>
 *   <li>Event 발행 → Listener에서 파일 백업</li>
 *   <li>수동 복구 가능한 형태로 데이터 보존</li>
 * </ul>
 * </p>
 *
...
public record LikeSyncFailedEvent(
     ...
     */
    public static LikeSyncFailedEvent fromFetchResult(FetchResult result, String sourceKey, Throwable cause) {
     ...
     */
    public static LikeSyncFailedEvent forSingleEntry(String userIgn, long count, String sourceKey, Throwable cause) {
        return new LikeSyncFailedEvent(
                null,
                sourceKey,
