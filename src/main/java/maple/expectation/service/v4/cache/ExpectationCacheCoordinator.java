 ...
 * <h3>책임</h3>
 * <ul>
 *   <li>Singleflight 패턴: TieredCache.get(key, Callable) 캐시 조회/저장</li>
 *   <li>GZIP+Base64 압축/해제</li>
 *   <li>L1 Fast Path 직접 조회</li>
 *   <li>fromCache 플래그 관리</li>
 * </ul>
 */
@Slf4j
@Component
public class ExpectationCacheCoordinator {
    ...
    private EquipmentExpectationResponseV4 executeCalculator(Callable<EquipmentExpectationResponseV4> calculator) {
    ...
    private byte[] compressToGzipBytes(EquipmentExpectationResponseV4 response, String userIgn) {
        ...
        return executor.executeWithTranslation(
                ...
                (e, ctx) -> new EquipmentDataProcessingException(
    ...
    private EquipmentExpectationResponseV4 decompressCachedResponse(String compressedBase64, String userIgn) {
        return executor.executeWithTranslation(
                ...
                (e, context) -> new EquipmentDataProcessingException(
    ...
    private EquipmentExpectationResponseV4 rebuildWithCacheFlag(EquipmentExpectationResponseV4 original) {
