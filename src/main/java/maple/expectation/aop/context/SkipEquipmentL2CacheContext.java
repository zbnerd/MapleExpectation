...
/**
 * Expectation 경로에서 EquipmentResponse L2(Redis) 저장을 스킵하기 위한 MDC 기반 컨텍스트
 * (#271 V5 Stateless Architecture)
 *
...
public final class SkipEquipmentL2CacheContext {
     ...
     *
     * <p>V5 마이그레이션 중 Boolean 타입을 사용하는 기존 코드 지원.
     * 신규 코드는 String 기반 snapshot()/restore(String)을 사용하십시오.
     *
