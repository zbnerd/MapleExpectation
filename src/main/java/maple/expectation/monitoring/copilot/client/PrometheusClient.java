 ...
 * Uses Java 11+ HttpClient with Jackson for JSON parsing.
 *
...
public class PrometheusClient {
    ...
    /**
     * Internal query implementation with checked exceptions.
     * Called by LogicExecutor or directly in legacy mode.
     */
    private List<TimeSeries> queryRangeInternal(String promql, Instant start, Instant end, String step) {
        ...
        if (response.statusCode() != 200) {
            throw new InternalSystemException(
                    String.format("Prometheus query failed: HTTP %d - %s",
    ...
    public record PrometheusResponse(String status, QueryResponseData data) {
        ...
        public static PrometheusResponse create(
                ...
                @JsonProperty("data") QueryResponseData data
        ) {
    ...
    public record ValuePoint(
        ...
        public static ValuePoint create(
                @JsonProperty("0") long timestamp,
                @JsonProperty("1") String value
        ) {
