 ...
 * <p>BigDecimal 금액을 "조/억/만" 단위로 변환합니다.</p>
 *
 * <h3>예시</h3>
 * <ul>
 *   <li>12345678900000 → "12조 3456억 7890만"</li>
 *   <li>500000000000 → "5000억"</li>
 *   <li>50000000 → "5000만"</li>
 *   <li>1234567 → "123만"</li>
 * </ul>
 *
 * <h3>메이플스토리 금액 특성</h3>
 * <ul>
 *   <li>일반적으로 만 메소 단위 이상의 금액 처리</li>
 *   <li>억 단위는 큐브 비용에서 흔함</li>
 *   <li>조 단위는 스타포스 22성 이상에서 발생</li>
 * </ul>
 */
