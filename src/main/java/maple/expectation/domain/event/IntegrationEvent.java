 ...
 * This is part of the Anti-Corruption Layer (ACL) that isolates external systems
 * from internal processing pipelines.
 *
 * <p><strong>SOLID Compliance:</strong>
 * <ul>
 *   <li><b>SRP:</b> Single responsibility - event metadata container</li>
 *   <li><b>OCP:</b> Open for extension (generic T), closed for modification</li>
 *   <li><b>DIP:</b> Domain layer doesn't depend on infrastructure</li>
 * </ul>
 *
...
public class IntegrationEvent<T> {
  ...
  /**
   * Event type identifier (e.g., "NEXON_DATA_COLLECTED", "CHARACTER_UPDATED").
   * Used for event routing and filtering.
   */
  private String eventType;

  /**
   * Event creation timestamp in epoch milliseconds.
   * Used for event ordering and latency measurement.
   */
  private long timestamp;

  /**
   * Actual event payload.
   * Can be any domain object that needs to be transmitted through the pipeline.
   */
  private T payload;
   ...
   * <ul>
   *   <li>eventId: UUID generation</li>
   *   <li>timestamp: Current time in epoch millis</li>
   * </ul>
   *
   ...
   */
  public static <T> IntegrationEvent<T> of(String eventId, String eventType, long timestamp, T payload) {
