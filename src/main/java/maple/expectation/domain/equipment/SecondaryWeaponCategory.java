 ...
 * <p>item_equipment_slot = "보조무기"일 때:</p>
 * <ul>
 *   <li>item_equipment_part가 "포스실드" 또는 "소울링" → FORCE_SHIELD 잠재</li>
 *   <li>그 외 → STANDARD_SECONDARY 잠재</li>
 * </ul>
 *
 * <h3>잠재능력 확률 테이블 차이</h3>
 * <ul>
 *   <li>STANDARD_SECONDARY: 보조무기 확률 테이블 사용</li>
 *   <li>FORCE_SHIELD: 포스실드 확률 테이블 사용 (더 높은 보공/마공 확률)</li>
 * </ul>
 */
@Getter
...
public enum SecondaryWeaponCategory {
    ...
    /**
     * 일반 보조무기 (방패, 책, 부적 등)
     * <p>보조무기 잠재 확률 테이블 사용</p>
     */
    STANDARD_SECONDARY("보조무기"),

    /**
     * 포스실드/소울링 (데몬어벤저, 제논 등)
     * <p>포스실드 잠재 확률 테이블 사용</p>
     */
    FORCE_SHIELD("포스실드");
