    ...
    if (enabled) {
      if (windowPoints < minRequiredPoints) {
        throw new IllegalArgumentException(
            String.format(
                "windowPoints (%d) must be >= minRequiredPoints (%d)",
