 ...
 *
 * <ul>
 *   <li>[P0-Green] 5% Head Sampling (비용 최적화)
 *   <li>[P0-Blue] Actuator 엔드포인트 트레이싱 제외
 *   <li>Error 100% Tail Sampling (에러 시 무조건 수집)
 * </ul>
 *
 * <h4>Context7 Best Practice</h4>
 *
 * <p>RuleBasedRoutingSampler로 특정 경로 제외
 *
 * @see <a
 *     href="https://opentelemetry.io/docs/zero-code/java/spring-boot-starter/sdk-configuration">OTel
 *     Docs</a>
 */
@Slf4j
@Configuration
...
public class OpenTelemetryConfig {
   ...
   *
   * <p>/actuator/* 경로는 health check, metrics 수집 등으로 빈번히 호출되므로 트레이싱에서 제외하여 노이즈를 줄입니다.
   *
