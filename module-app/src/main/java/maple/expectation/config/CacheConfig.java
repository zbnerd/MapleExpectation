...
public class CacheConfig {
   ...
   * </ul>
   */
  private CacheManager createL2Manager(
   ...
   */
  @Bean
  @Qualifier("expectationCacheSerializer") public RedisSerializer<Object> expectationCacheSerializer(ObjectMapper objectMapper) {
