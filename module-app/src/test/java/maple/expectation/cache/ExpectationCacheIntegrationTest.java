 ...
 *
 * <ul>
 *   <li>B3: L2 CacheManager에서 equipment 캐시 구조적 봉쇄
 *   <li>B4: L2 타입 복원 검증 (LinkedHashMap 아닌 원본 타입)
 *   <li>M2: Typed Serializer에 @class 메타데이터 없음
 * </ul>
 */
@Tag("integration")
...
class ExpectationCacheIntegrationTest extends IntegrationTestSupport {
  ...
  @Autowired
  @Qualifier("expectationL1CacheManager") private CacheManager l1CacheManager;

  @Autowired
  @Qualifier("expectationL2CacheManager") private CacheManager l2CacheManager;

  @Autowired
  @Qualifier("expectationCacheSerializer") private RedisSerializer<Object> expectationCacheSerializer;
