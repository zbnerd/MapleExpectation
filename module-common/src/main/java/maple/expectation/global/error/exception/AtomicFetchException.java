 ...
 *
 * <ul>
 *   <li>CircuitBreakerRecordMarker 구현으로 서킷브레이커 장애 기록
 *   <li>Redis 장애 시 Graceful Degradation 트리거
 *   <li>cause 보존으로 Exception Chaining 유지
 * </ul>
 *
 * @since 2.0.0
 */
public class AtomicFetchException extends ServerBaseException
