 ...
 *
 * <p>MySQL 복구 후 Compensation Log를 DB에 동기화하는 과정에서 실패했을 때 발생합니다.
 *
 ...
 *
 * <ul>
 *   <li>3회 재시도 (exponential backoff: 1s, 2s, 4s)
 *   <li>3회 실패 시 DLQ로 이동
 * </ul>
 */
public class CompensationSyncException extends ServerBaseException
