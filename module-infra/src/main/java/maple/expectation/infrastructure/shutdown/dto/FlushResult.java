 ...
 *
 * <p>{@code LikeSyncService.flushLocalToRedisWithFallback()} 메서드의 반환값으로 사용되며, 성공/실패 건수를 추적합니다.
 *
 * <p>Java 17 record를 사용하여 immutable 데이터 구조를 보장합니다.
 *
 * @param redisSuccessCount Redis로 성공적으로 전송된 항목 수
 * @param fileBackupCount Redis 실패로 로컬 파일에 백업된 항목 수
 */
public record FlushResult(int redisSuccessCount, int fileBackupCount) {
