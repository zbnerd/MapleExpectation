 ...
 *
 * <ul>
 *   <li>읽기 전용 캐시: SpEL Expression 파싱 결과 캐싱 (변경 없음)
 *   <li>인스턴스별 독립: 각 인스턴스가 동일한 Expression을 파싱해도 결과 동일
 *   <li>비즈니스 영향 없음: 캐시 없어도 기능 동작, 성능 최적화용
 * </ul>
 *
...
public class CustomSpelParser {
  ...
  public String parseWithFallback(
      ProceedingJoinPoint joinPoint, String expression, String fallback) {
  ...
  /** ✅ 제네릭 parse 평탄화 */
  public <T> T parse(
      ProceedingJoinPoint joinPoint, String expression, Class<T> resultType, T fallback) {
