...
public class NexonApiOutbox {
  ...
  /** 팩토리 메서드 (Outbox 적재) */
  public static NexonApiOutbox create(
      String requestId, NexonApiEventType eventType, String payload) {
  ...
  private static String computeContentHash(
    ...
    try {
      ...
      byte[] hash =
          digest.digest(
              (requestId + "|" + eventType + "|" + payload).getBytes(StandardCharsets.UTF_8));
