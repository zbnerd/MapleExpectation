...
- [ ] Test does not reproduce the Connection Pool exhaustion
- [ ] HikariCP configuration differs from production
- [ ] Mock API doesn't actually delay (real delay required)
- [ ] Transaction behavior differs (@Transactional propagation)
- [ ] Connection timeout settings differ significantly
