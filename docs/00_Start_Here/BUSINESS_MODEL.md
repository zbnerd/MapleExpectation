...
|-------|-------------|----------|
| **Instant Calculation** | 장비 강화 비용 즉시 계산 | p50 27ms (Warm Cache) |
| **High Concurrency** | 1,000+ 동시 사용자 지원 | 15,000 등가 사용자 |
...
|--------|-------|-------------|
| **Cost per 1000 RPS-hour** | ~$0.06 | $15 / (235.7 × 24 × 30) |
